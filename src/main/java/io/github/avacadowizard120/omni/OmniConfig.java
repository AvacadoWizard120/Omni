...
public final class OmniConfig {
    ...
    public static boolean hasCustomSpeed() {
        refreshIfNeeded(false);
        return !near(forwardMultiplier, 1.0F)
                || !near(backwardMultiplier, 1.0F)
                || !near(leftMultiplier, 1.0F)
                || !near(rightMultiplier, 1.0F)
                || !near(forwardLeftMultiplier, 1.0F)
                || !near(forwardRightMultiplier, 1.0F)
                || !near(backwardLeftMultiplier, 1.0F)
                || !near(backwardRightMultiplier, 1.0F);
    }
