...
stonecutter {
    create(rootProject) {
        ...
        mc("1.6.4", "legacyfabric")
        mc("1.7.2", "legacyfabric")
        ...
        mc("1.7.10", "legacyfabric")
        mc("1.8", "forge", "legacyfabric")
        ...
        mc("1.8.9", "forge", "legacyfabric")
        mc("1.9", "forge")
        mc("1.9.4", "forge", "legacyfabric")
        mc("1.10", "forge")
        mc("1.10.2", "forge", "legacyfabric")
        mc("1.11", "forge")
        mc("1.11.2", "forge", "legacyfabric")
        mc("1.12", "forge")
        mc("1.12.1", "forge")
